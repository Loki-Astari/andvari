...
function CopyOtherFilesToDest(appData, root, page, reject) {
    return new Promise(function(resolve, reject) {
        var src = page.obj;
...
function CopyOtherFiles(appData, page, reject) {
    return CopyOtherFilesToDest(appData, appData.app.dir.public, page, reject);
}
function CopyLayoutFiles(appData, page, reject) {
    return CopyOtherFilesToDest(appData, appData.app.dir.skelLayout, page, reject);
}
...
function processPages(appData) {
    return new Promise(function(resolve, reject) {
        ...
        .then(function() {
            ...
            buildAllFiles(appData, appData.layouts, 'Build Layout', CopyLayoutFiles, (page) => page.obj);
