...
function build(appData) {
    ...
    appData.config = Object.assign({}, configTheme, configMain);

    /*
     * Load Scripts
     */
    var appScript   = loadScripts(appData.app.dir.defScript);
    var themeScript = loadScripts(appData.app.dir.themes + '/' + appData.config.theme + '/script');
    var layScript   = loadScripts(appData.app.dir.script);
    ...
    Object.assign(appData, appScript, themeScript, layScript);
    ...
    .then(() => avutil.processesDir(appData, appData.app.dir.theme + '/layout', ignoreUnderscore, addLayoutFile, () => {}))
