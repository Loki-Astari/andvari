...
function processPages(appData) {
    ...
    for(var loop = 0; loop < appData.pageSources.length; loop++) {
        ...
        //pageData.excerpt = matterData.content.substr(0, appData.config.excerptSize);
        //pageData.more    = matterData.content.substr(appData.config.excerptSize);
        ...
        pushOrApply(appData.site.series, pageData.series);
        pushOrApply(appData.site.categories, pageData.categories);
