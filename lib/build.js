...
function build(appData, resolve, reject) {
    ...
    appData.stylus      = [];
    appData.copyFiles   = [];
    appData.layouts     = [({dir: appData.app.dir.appLayout,  obj: appData.app.dir.appLayout + 'page.ejs', name: 'page'})];
    ...
    .then(() => avutil.processesDir(appData, appData.app.dir.themeLayout, ignoreUnderscore, addLayoutFile, avutil.buildSkelLayoutDir))
    .then(() => avutil.processesDir(appData, appData.app.dir.layout, ignoreUnderscore, addLayoutFile, avutil.buildSkelLayoutDir))
