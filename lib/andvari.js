...
function andvari() {
    ...
    subparsers.addParser( 'init', {addHelp:true, description: 'Init an Andvari Web Site',}
        ...
        [ '--themeRepo' ], { action: 'store', type: 'string', help: 'The Github repo to use as the theme', defaultValue: 'https://github.com/Loki-Astari/andvari-theme-landscape.git'}
    ).addArgument(
    ...
    var appDir = {
        ...
        skelLayout: path.normalize(blogRoot + '/layoutskel/'),
